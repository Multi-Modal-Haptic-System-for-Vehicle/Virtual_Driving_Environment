...
public class LogitechSteeringWheel : MonoBehaviour
{
    ...
    [HideInInspector] public float inputWheel;
    [HideInInspector] public float inputAccel;
    [HideInInspector] public float inputBreak;
    ...
    void OnGUI()
    {
        ...
        actualState = GUI.TextArea(new Rect(200, 10, 200, 200), actualState, 1000);
        buttonStatus = GUI.TextArea(new Rect(410, 10, 200, 200), buttonStatus, 1000);
        GUI.Label(new Rect(10, 360, 800, 400), forcesLabel);
    }
