...
public class DemoCarController : MonoBehaviour
{
    ...
    public LogitechSteeringWheel logitechSteeringWheel;
    ...
    private void Update()
    {
        ...
        //float breakInput = Input.GetAxis("Break");
        //float rawForwardInput = forwardInput - breakInput;
        float parkInput = Input.GetAxis("Jump");

        float rawSteeringInput = logitechSteeringWheel.inputWheel / 32767;
        float forwardInput = logitechSteeringWheel.inputAccel / 32767;
        float breakInput = logitechSteeringWheel.inputBreak / 32767;
        float rawForwardInput = -forwardInput + breakInput;
